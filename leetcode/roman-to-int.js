...
//My Submissions
//  Runtime 225 ms          Beats 34.14% of entries
...
// extra evaluation makes it slightly slower?? I can do better
// for (var k of Object.keys(rns)) { 
//     if (s.length == 1) {
//         n += rns[s];
//         break;
...
//     //adding if-break exits doesn't really speed it up
//     if (s == '') {
//         break;
//     } else if (s.length == 1) {
//         n += rns[s];
...
//     //this is slower than the for-of loop
// Object.entries(rns).forEach(([k,v]) => {
//     while (s.includes(k)) {
//         n += v;
//         s = s.replace(k,'');
//     };
...
//using a map is slower than the object
// const rns = new Map();
// rns.set("CM",900);
// rns.set("M",1000);
// rns.set("CD",400);
...
//source: https://oeis.org/A006968/a006968.txt
var romandictionary = {
    I:1,
    II:2,
    III:3,
